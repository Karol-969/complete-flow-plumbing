  ...
  return (
    <Layout>
      <SEOHead
        ...
        description={`${service.shortDescription} Trusted ${service.title.toLowerCase()} across the Southern Highlands, Wollondilly, Macarthur, the Sutherland Shire, St George, Bayside, the Eastern Suburbs, Wollongong & Illawarra, the Blue Mountains, Western Sydney, and Goulburn & the Southern Tablelands. No call-out fee, upfront pricing, fast emergency response. Call 0468 723 029.`}
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  <p>
                    ...
                    services to homes and businesses across the Southern Highlands, Wollondilly, Macarthur, the Sutherland Shire, St George, Bayside, the Eastern Suburbs, Wollongong &amp; Illawarra, the Blue Mountains, Western Sydney, and Goulburn &amp; the Southern Tablelands.
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  We provide {service.title.toLowerCase()} services across the Southern Highlands, Wollondilly, Macarthur, the Sutherland Shire, St George, Bayside, the Eastern Suburbs, Wollongong &amp; Illawarra, the Blue Mountains, Western Sydney, and Goulburn &amp; the Southern Tablelands, including:
                </p>
                <div className="flex flex-wrap gap-3">
