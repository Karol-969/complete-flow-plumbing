...
const blogPosts: Record<string, {
  ...
  "blocked-drains-sydney-tree-roots": {
    ...
    content: [
      ...
      "- Bottlebrush — Common in western Sydney gardens",
  ...
  "pipe-relining-vs-replacement-sydney": {
    ...
    content: [
      ...
      "In newer western Sydney suburbs (Campbelltown, Camden), pipes are often PVC which is less prone to root intrusion but still benefits from relining when damaged.",
